...
const features = [
  {
    ...
    desc: "From raw idea to multi-platform scheduled post at a pace that redefines fast. Because manual scheduling isn't a strategy."
  },
  {
    icon: Palette,
    title: "Platform Specific",
    desc: "Every crop considered. Every caption refined. Videos exported exactly for Instagram, TikTok, and YouTube."
  },
  {
    icon: BarChart3,
    title: "Built to Convert",
    desc: "Insights informed by data. Hook retention backed by performance. Results you can measure."
  },
  {
    icon: Shield,
    title: "Local AI First",
    desc: "Enterprise-grade privacy comes standard. Local Whisper and Ollama integrations keep your ideas secure."
  }
]
